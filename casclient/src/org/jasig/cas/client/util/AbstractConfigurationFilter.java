...
/**
 * Abstracts out the ability to configure the filters from the initial
 * properties provided.
 * 
...
public abstract class AbstractConfigurationFilter implements Filter {
	...
	/**
	 * Retrieves the property from the FilterConfig. First it checks the
	 * FilterConfig's initParameters to see if it has a value. If it does, it
	 * returns that, otherwise it retrieves the ServletContext's initParameters
	 * and returns that value if any.
	 * <p>
	 * Finally, it will check JNDI if all other methods fail. All the JNDI
	 * properties should be stored under either
	 * java:comp/env/cas/SHORTFILTERNAME/{propertyName} or
	 ...
	 * @return the property value, following the above conventions. It will
	 *         always return the more specific value (i.e. filter vs. context).
	 */
